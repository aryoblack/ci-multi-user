...
$(document).ready(function() {
 ...
 table =$("#tabellevel").DataTable({
        ...
        { 
          ...
          "targets" : [1],
          "render" : function (data, type, row) {
            return "<a class=\"btn btn-xs btn-info\" href=\"javascript:void(0)\" title=\"Hak Akses Menu\" onclick=\"aksesmenu("+row[1]+")\">Hak Akses Menu</a> <a class=\"btn btn-xs btn-primary\" href=\"javascript:void(0)\" title=\"Hak Akses Submenu\" onclick=\"aksessubmenu("+row[1]+")\">Hak Akses Submenu</a>";
          }
